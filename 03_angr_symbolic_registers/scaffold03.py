...
def main(argv):
  ...
  # (!)
  '''
  .text:0000000000401553                 call    get_user_input
  .text:0000000000401558                 mov     [rbp+var_C], eax
  .text:000000000040155B                 mov     [rbp+var_8], ebx
  .text:000000000040155E                 mov     [rbp+var_4], edx
  '''
  start_address = 0x401558   # :integer (probably hexadecimal)
  ...
  if simulation.found:
    ...
    solution = "0x%x 0x%x 0x%x" %(solution0, solution1, solution2)
    print(solution)
  else:
